() {
  ...
  typeset -gi __p9k_instant_prompt_disabled=1 __p9k_instant_prompt_sourced=11
  [[ -t 0 && -t 1 && -t 2 && $ZSH_VERSION == 5.6.2 && $ZSH_PATCHLEVEL == zsh-5.6.2-0-g92bef88 &&
  ...
  local cr=$'\r' lf=$'\n' esc=$'\e[' rs=$'\x1e' us=$'\x1f'
  local -i height=1
  local prompt_dir=/home/rezgar/.cache/p10k-rezgar
  ...
  local -A _p9k__display_k=(1/left/dir 17 empty_line 1 1/gap 15 1/right/command_execution_time 23 -1/right/background_jobs 27 -1/left 11 -1 5 1/right/history 29 1/left 11 1/right/background_jobs 27 -1/left/dir 17 -1/gap 15 -1/right_frame 9 1/right_frame 9 1/left/vcs 19 1/right 13 1/right/time 31 -1/right/root_indicator 25 1/right/status 21 -1/right/time 31 -1/right/command_execution_time 23 -1/right 13 -1/right/status 21 -1/right/history 29 1/right/root_indicator 25 -1/left/vcs 19 1/left_frame 7 1 5 -1/left_frame 7 ruler 3)
  local -a _p9k__display_v=(empty_line hide ruler hide 1 show 1/left_frame show 1/right_frame show 1/left show 1/right show 1/gap show 1/left/dir show 1/left/vcs show 1/right/status show 1/right/command_execution_time show 1/right/root_indicator show 1/right/background_jobs show 1/right/history show 1/right/time show)
  function p10k() {
    emulate -L zsh
